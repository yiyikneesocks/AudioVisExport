...
> 开发视角的完整变更记录见 `ARCHITECTURE.md` §12。本文件自 v0.4.2 起启用。
...
## v0.4.2 — 2026-09-05（图片图层 + bar-line 样式 + WSL 迁移）
...
### 历史版本
- v0.4.0 / v0.4.1 的变更见 `ARCHITECTURE.md` §12（本公告文件自 v0.4.2 起启用，此前无公告存档）。
